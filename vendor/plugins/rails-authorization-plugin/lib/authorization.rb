    ...
    module ControllerInstanceMethods
      ...
      def handle_redirection
        ...
        if @current_user && @current_user != :false
          error @options[:permission_denied_message] || I18n.t("application.permission_denied", :default => "Permission denied. You cannot access the requested page.")
          redirect_to @options[:permission_denied_redirection] || PERMISSION_DENIED_REDIRECTION
        else
          error @options[:login_required_message] || I18n.t("application.login_required", :default => "Login is required to access the requested page.")
